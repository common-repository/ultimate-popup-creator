<script type="text/javascript">
	jQuery(document).ready(function($) {
		//Getting Font Name
		var fonts = [
			"<?php echo get_option('wpappp-popup7-heading-font-family-option') ?>", 
			"<?php echo get_option('wpappp-popup7-subheading-font-family-option') ?>",
			"<?php echo get_option('wpappp-popup7-closing-note-font-family-option') ?>"
		];
...
#wpup-popup7-heading1{
	...
	#wpup-popup7-container {
		width: <?php echo get_option('wpappp-popup7-width-option') ?>px !important;
		background-color: <?php echo get_option('wpappp-popup7-background-color-option') ?> !important;
		border-left: 5px solid <?php echo get_option('wpappp-popup7-action-button-background-color-option') ?> !important;
	}
	#wpup-popup7-heading1 {
		color: <?php echo get_option('wpappp-popup7-heading-text-color-option') ?> !important;
		font-size: <?php echo get_option('wpappp-popup7-heading-font-size-option') ?> !important;
	}
	#wpup-popup7-heading2 {
		color: <?php echo get_option('wpappp-popup7-subheading-text-color-option') ?> !important;
		font-size: <?php echo get_option('wpappp-popup7-subheading-font-size-option') ?> !important;
	}
	#wpup-popup7-email-text {
		border: 1px solid <?php echo get_option('wpappp-popup7-email-textfield-border-color-option') ?> !important;
	}
	#wpup-popup7-button {
		background-color: <?php echo get_option('wpappp-popup7-action-button-background-color-option') ?> !important;
	}
	#wpup-popup7-close-note {
		color: <?php echo get_option('wpappp-popup7-closing-note-text-color-option') ?> !important;
	}
	#wpappp-popup7{
		    background: rgba(0,0,0,<?php echo get_option('wpappp-popup7-overlay-option') ?>);
	}
</style>

<?php 
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
echo '<div id="wpappp-popup7" class="wpappp_popup_wrapper_container" style="display:none;">
		<div id="wpup-popup7-container">

			<div id="wpup-popup7-close-button"><a href="#"><img id="wpappp_popup_close_button" src="'.plugins_url('../images/popup7-img/close.png', __FILE__).'"></a></div>
			<h3 id="wpup-popup7-heading1">'.get_option('wpappp-popup7-heading-text-option').'</h3>
			<h3 id="wpup-popup7-heading2">'.get_option('wpappp-popup7-subheading-text-option').'</h3>
			<div id="upc_email_text_field"><input type="text"  class="wpappp_subscriber_email_submit" id="wpup-popup7-email-text" name="" value="" placeholder="'.get_option('wpappp-popup7-email-textfield-placeholder-option').'">
				<input type="submit" class="wpappp-subscribe-button-submit" id="wpup-popup7-button" name="" value=""></div>
				<p id="upc_closing_note"><a id="wpup-popup7-close-note">'.get_option('wpappp-popup7-closing-note-text-option').'</a></p>
